<template>
  <div class="pagination">
    ...
    <!-- :class="{active:page==pageNo}"等号左右可不分 -->
    <button v-for="page in startAndEnd.end" :key="page" v-if="page >= startAndEnd.start" @click="$emit('currentPage',page)" :class="{active:page==pageNo}">{{ page }}</button>
